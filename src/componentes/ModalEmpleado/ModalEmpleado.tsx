      ...
      {modalType === ModalType.DELETE && (
        <>
          ...
          >
            ...
            <Modal.Body>
              <p>
                ¿Está seguro que desea dar de baja el Empleado?
          ...
          >
            ...
            <Modal.Body>
              <Form onSubmit={formik.handleSubmit}>
                ...
                <Form.Group controlId="formUsernameEmpleado">
                  <Form.Label>Usuario Empleado</Form.Label>
                  <Form.Control
                    name="username"
                    type="text"
              ...
              <Form onSubmit={formik2.handleSubmit}>
                ...
                <Form.Group controlId="formUsernameEmpleado">
                  ...
                  <Form.Control
                    ...
                    isInvalid={Boolean(
                      formik2.errors.username && formik2.touched.username
                    )}
                  />
                  <Form.Control.Feedback type="invalid">
                ...
                <Form.Group controlId="formNombreEmpleado">
                  ...
                  <Form.Control
                    ...
                    onBlur={formik2.handleBlur}
                    isInvalid={Boolean(
                      formik2.errors.nombre && formik2.touched.nombre
                    )}
                  />
                  <Form.Control.Feedback type="invalid">
                ...
                <Form.Group controlId="formApellido">
                  ...
                  <Form.Control
                    ...
                    onBlur={formik2.handleBlur}
                    isInvalid={Boolean(
                      formik2.errors.apellido && formik2.touched.apellido
                    )}
                  />
                  <Form.Control.Feedback type="invalid">
                    {formik.errors.apellido}
                ...
                <Form.Group controlId="formTelefono">
                  ...
                  <Form.Control
                    ...
                    onBlur={formik2.handleBlur}
                    isInvalid={Boolean(
                      formik2.errors.telefono && formik2.touched.telefono
                    )}
                  />
                  <Form.Control.Feedback type="invalid">
                ...
                <Form.Group controlId="formPassword">
                  ...
                  <Form.Control
                    ...
                    )} // chequear si con formik podemos verifica el password y su sintaxis probablemente la del back no haga falta
                  />
                  <Form.Control.Feedback type="invalid">
                ...
                <Form.Group controlId="formRol">
                  ...
                  <Form.Control
                    ...
                    onBlur={formik2.handleBlur}
                    isInvalid={Boolean(
                      formik2.errors.rol && formik2.touched.rol
                    )}
                  />
                  <Form.Control.Feedback type="invalid">
                    {formik2.errors.rol}
